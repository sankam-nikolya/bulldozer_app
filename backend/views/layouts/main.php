...
use backend\widgets\menu\MenuWidget;
use bulldozer\App;
    ...
    <html lang="<?= App::$app->language ?>">
        <head>
            ...
            <style>
                ...
                div#preloader { position: fixed; left: 0; top: 0; z-index: 999; width: 100%; height: 100%; overflow: visible; background-color: #000; }
            </style>
        </head>
                ...
                <header class="header">
                    <div class="logo-container">
                        <a href="<?=Url::home()?>" class="logo">
                            <img src="<?=$bundle->baseUrl?>/images/logo.png" height="35" alt="Tempest Keep Admin Panel" />
                        </a>
                    ...
                    <div class="header-right">
                            ...
                            <div id="userbox" class="userbox">
                                <a href="#" data-toggle="dropdown">
                                    <figure class="profile-picture">
                                        <img src="<?=$bundle->baseUrl?>/images/!logged-user.jpg" alt="<?=App::$app->user->identity->email?>" class="img-circle"
                                ...
                                <div class="dropdown-menu">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a role="menuitem" tabindex="-1" href="<?=Url::to(['/users/logout'])?>" data-method="post"><i class="fa fa-power-off"></i> Выйти</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        <?php else: ?>
                            <div id="userbox" class="userbox">
                                <a href="<?=Url::to(['/users/login'])?>">Вход</a>
                            </div>
                        <?php endif ?>
                    </div>
                    <!-- end: search & user box -->
